<%!
  import math
  from includes import num_tiles, num_ldpes, num_dsp_per_ldpe, orf_dwidth, \
    num_reduction_stages, in_precision, out_precision, num_elems_mfu, \
    vec_bram_dwidth, mat_bram_dwidth, mac_per_dsp, target_op_width, DESIGN_SIZE
%>
...
`define ORF_DWIDTH ${orf_dwidth} //${out_precision*num_ldpes} //${max(out_precision*num_ldpes,vec_bram_dwidth*math.ceil(num_dsp_per_ldpe*mac_per_dsp*in_precision/vec_bram_dwidth))}
...
`define DESIGN_SIZE ${DESIGN_SIZE}
