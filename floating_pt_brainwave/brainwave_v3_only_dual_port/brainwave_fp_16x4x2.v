...
module controller( 
    ...
    if(reset_npu == 1'b1) begin
          ...
          vrf_wr_enable_mvu_4<='bX;
          vrf_readn_enable_mvu_4 <= 'bX;


          vrf_wr_enable_mvu_5<='bX;
          vrf_readn_enable_mvu_5 <= 'bX;


          vrf_wr_enable_mvu_6<='bX;
          vrf_readn_enable_mvu_6 <= 'bX;


          vrf_wr_enable_mvu_7<='bX;
          vrf_readn_enable_mvu_7 <= 'bX;


          vrf_wr_enable_mvu_8<='bX;
          vrf_readn_enable_mvu_8 <= 'bX;


          vrf_wr_enable_mvu_9<='bX;
          vrf_readn_enable_mvu_9 <= 'bX;


          vrf_wr_enable_mvu_10<='bX;
          vrf_readn_enable_mvu_10 <= 'bX;


          vrf_wr_enable_mvu_11<='bX;
          vrf_readn_enable_mvu_11 <= 'bX;


          vrf_wr_enable_mvu_12<='bX;
          vrf_readn_enable_mvu_12 <= 'bX;


          vrf_wr_enable_mvu_13<='bX;
          vrf_readn_enable_mvu_13 <= 'bX;


          vrf_wr_enable_mvu_14<='bX;
          vrf_readn_enable_mvu_14 <= 'bX;


          vrf_wr_enable_mvu_15<='bX;
          vrf_readn_enable_mvu_15 <= 'bX;
